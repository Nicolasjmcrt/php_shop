...
<body>
    ...
    <?php if ($_GET['category']  == 'iPad') : ?>
        ...
        <div class="container hero-category d-flex flex-column m-auto justify-content-center p-5 ">
            ...
            <div class="compare-grid d-flex justify-content-around w-80">
                <div class="ipad-grid d-flex flex-column align-items-center text-center">
                    <a href="<?= URL ?>category.php?category=iPad&sub_category=iPad Pro#display">
                    ...
                    <a href="<?= URL ?>category.php?category=iPad&sub_category=iPad Pro#display" class="categ-h3-link">
                ...
                <div class="ipad-grid d-flex flex-column align-items-center text-center">
                    <a href="<?= URL ?>category.php?category=iPad&sub_category=iPad Air#display">
                    ...
                    <a href="<?= URL ?>category.php?category=iPad&sub_category=iPad Air#display" class="categ-h3-link">
                ...
                <div class="ipad-grid d-flex flex-column align-items-center text-center">
                    <a href="<?= URL ?>category.php?category=iPad&sub_category=iPad 10th gen#display">
                    ...
                    <a href="<?= URL ?>category.php?category=iPad&sub_category=iPad 10th gen#display" class="categ-h3-link">
                ...
                <div class="ipad-grid d-flex flex-column align-items-center text-center">
                    <a href="<?= URL ?>category.php?category=iPad&sub_category=iPad 9th gen#display">
                    ...
                    <a href="<?= URL ?>category.php?category=iPad&sub_category=iPad 9th gen#display" class="categ-h3-link">
                ...
                <div class="ipad-grid d-flex flex-column align-items-center text-center">
                    <a href="<?= URL ?>category.php?category=iPad&sub_category=iPad mini#display">
                    ...
                    <a href="<?= URL ?>category.php?category=iPad&sub_category=iPad mini#display" class="categ-h3-link">
        ...
        <div id="display" class="container category-container mt-3 mb-5 d-flex flex-wrap w-80 justify-content-around">


            <?php if (isset($_GET['category']) && isset($_GET['sub_category'])) : ?>

                <?php $reqCat = $connect->query("SELECT * FROM product WHERE sub_category = '$_GET[sub_category]' ORDER BY price ASC");
        ...
        <div class="container hero-category d-flex flex-column m-auto justify-content-center p-5 ">
            ...
            <div class="compare-grid d-flex justify-content-around w-80">
                <div class="iphone-grid d-flex flex-column align-items-center text-center">
                    <a href="<?= URL ?>category.php?category=iPhone&sub_category=iPhone 14 Pro#display">
                    ...
                    <a href="<?= URL ?>category.php?category=iPhone&sub_category=iPhone 14 Pro#display" class="categ-h3-link">
                ...
                <div class="iphone-grid d-flex flex-column align-items-center text-center">
                    <a href="<?= URL ?>category.php?category=iPhone&sub_category=iPhone 14#display">
                    ...
                    <a href="<?= URL ?>category.php?category=iPhone&sub_category=iPhone 14#display" class="categ-h3-link">
                ...
                <div class="iphone-grid d-flex flex-column align-items-center text-center">
                    <a href="<?= URL ?>category.php?category=iPhone&sub_category=iPhone 13#display">
                    ...
                    <a href="<?= URL ?>category.php?category=iPhone&sub_category=iPhone 13#display" class="categ-h3-link">
                ...
                <div class="iphone-grid d-flex flex-column align-items-center text-center">
                    <a href="<?= URL ?>category.php?category=iPhone&sub_category=iPhone SE#display">
                    ...
                    <a href="<?= URL ?>category.php?category=iPhone&sub_category=iPhone SE#display" class="categ-h3-link">
        ...
        <div class="container hero-category d-flex flex-column m-auto justify-content-center p-5 ">
            ...
            <div class="compare-grid d-flex justify-content-around w-80">
                <div class="watch-grid d-flex flex-column align-items-center text-center">
                    <a href="<?= URL ?>category.php?category=Watch&sub_category=Apple Watch Series 8#display">
                    ...
                    <a href="<?= URL ?>category.php?category=Watch&sub_category=Apple Watch Series 8#display" class="categ-h3-link">
                        <h3 class="h3-compare">Apple Watch Series 8</h3>
                    </a>
                    <p class="compare-price">From 499 €</p>
                </div>
                <div class="watch-grid d-flex flex-column align-items-center text-center">
                    <a href="<?= URL ?>category.php?category=Watch&sub_category=Apple Watch SE#display">
                    ...
                    <a href="<?= URL ?>category.php?category=Watch&sub_category=Apple Watch SE#display" class="categ-h3-link">
                        <h3 class="h3-compare">Apple Watch SE</h3>
                    </a>
                    <p class="compare-price">From 299 €</p>
                </div>
                <div class="watch-grid d-flex flex-column align-items-center text-center">
                    <a href="<?= URL ?>category.php?category=Watch&sub_category=Apple Watch Ultra#display">
                    ...
                    <a href="<?= URL ?>category.php?category=Watch&sub_category=Apple Watch Ultra#display" class="categ-h3-link">
                        ...
                        <div class="accordion-body">
                            <div class="compare-grid d-flex justify-content-around w-80">
                                <div class="mac-grid d-flex flex-column align-items-center text-center">
                                    <a href="<?= URL ?>category.php?category=Mac&sub_category=MacBook Air M1#display">
                                    ...
                                    <a href="<?= URL ?>category.php?category=Mac&sub_category=MacBook Air M1#display" class="categ-h3-link">
                                ...
                                <div class="mac-grid d-flex flex-column align-items-center text-center">
                                    <a href="<?= URL ?>category.php?category=Mac&sub_category=MacBook Air M2#display">
                                    ...
                                    <a href="<?= URL ?>category.php?category=Mac&sub_category=MacBook Air M2#display" class="categ-h3-link">
                                        <h3 class="h3-compare">MacBook Air</h3>
                                    </a>
                                ...
                                <div class="mac-grid d-flex flex-column align-items-center text-center">
                                    <a href="<?= URL ?>category.php?category=Mac&sub_category=MacBook Pro 13”#display">
                                    ...
                                    <a href="<?= URL ?>category.php?category=Mac&sub_category=MacBook Pro 13”#display" class="categ-h3-link">
                                        <h3 class="h3-compare">MacBook Pro 13”</h3>
                                    </a>
                                    <p class="compare-price">From 1599 €</p>
                                </div>
                                <div class="mac-grid d-flex flex-column align-items-center text-center">
                                    <a href="<?= URL ?>category.php?category=Mac&sub_category=MacBook Pro 14” and 16”#display">
                                    ...
                                    <a href="<?= URL ?>category.php?category=Mac&sub_category=MacBook Pro 14” and 16”#display" class="categ-h3-link">
                ...
                <div class="accordion-item">
                    ...
                    <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
                        <div class="accordion-body">
                            <div class="compare-grid d-flex justify-content-around w-80">
                                <div class="mac-grid d-flex flex-column align-items-center text-center">
                                    <a href="<?= URL ?>category.php?category=Mac&sub_category=iMac 24”#display">
                                    ...
                                    <a href="<?= URL ?>category.php?category=Mac&sub_category=iMac 24”#display" class="categ-h3-link">
                                        <h3 class="h3-compare">iMac 24”</h3>
                                    </a>
                                    <p class="compare-price">From 1449 €</p>
                                </div>
                                <div class="mac-grid d-flex flex-column align-items-center text-center">
                                    <a href="<?= URL ?>category.php?category=Mac&sub_category=Mac mini#display">
                                    ...
                                    <a href="<?= URL ?>category.php?category=Mac&sub_category=Mac mini#display" class="categ-h3-link">
                                        <h3 class="h3-compare">Mac mini</h3>
                                    </a>
                                    <p class="compare-price">From 799 €</p>
                                </div>
                                <div class="mac-grid d-flex flex-column align-items-center text-center">
                                    <a href="<?= URL ?>category.php?category=Mac&sub_category=Mac Studio#display">
                                    ...
                                    <a href="<?= URL ?>category.php?category=Mac&sub_category=Mac Studio#display" class="categ-h3-link">
                                        <h3 class="h3-compare">Mac Studio</h3>
                                    </a>
                                    <p class="compare-price">From 2299 €</p>
                                </div>
                                <div class="mac-grid d-flex flex-column align-items-center text-center">
                                    <a href="<?= URL ?>category.php?category=Mac&sub_category=Mac Pro#display">
                                    ...
                                    <a href="<?= URL ?>category.php?category=Mac&sub_category=Mac Pro#display" class="categ-h3-link">
        ...
        <div class="container hero-category d-flex flex-column m-auto justify-content-center p-5 ">
            ...
            <div class="compare-grid d-flex justify-content-around w-80">
                <div class="airpods-grid d-flex flex-column align-items-center text-center">
                    <a href="<?= URL ?>category.php?category=AirPods&sub_category=AirPods 2nd gen#display">
                        <img src="./img/compare_airpods_2nd_gen.png" class="ipad-pro-fig figure-img img-fluid" alt="">
                    </a>
                    <a href="<?= URL ?>category.php?category=AirPods&sub_category=AirPods 2nd gen#display" class="categ-h3-link">
                ...
                <div class="airpods-grid d-flex flex-column align-items-center text-center">
                    <a href="<?= URL ?>category.php?category=AirPods&sub_category=AirPods 3rd gen#display">
                        <img src="./img/compare_airpods_3rd_gen.png" class="ipad-pro-fig figure-img img-fluid" alt="">
                    </a>
                    <a href="<?= URL ?>category.php?category=AirPods&sub_category=AirPods 3rd gen#display" class="categ-h3-link">
                        <h3 class="h3-compare">AirPods</h3>
                    </a>
                ...
                <div class="airpods-grid d-flex flex-column align-items-center text-center">
                    <a href="<?= URL ?>category.php?category=AirPods&sub_category=AirPods Pro#display">
                        <img src="./img/compare_airpods_pro.png" class="ipad-pro-fig figure-img img-fluid" alt="">
                    </a>
                    <a href="<?= URL ?>category.php?category=AirPods&sub_category=AirPods Pro#display" class="categ-h3-link">
                ...
                <div class="airpods-grid d-flex flex-column align-items-center text-center">
                    <a href="<?= URL ?>category.php?category=AirPods&sub_category=AirPods Max#display">
                        <img src="./img/compare_airpods_max.png" class="ipad-pro-fig figure-img img-fluid" alt="">
                    </a>
                    <a href="<?= URL ?>category.php?category=AirPods&sub_category=AirPods Max#display" class="categ-h3-link">
    ...
    <?php elseif ($_GET['category'] == 'TV/Home') : ?>
        ...
        <div class="container tv-big-cards d-flex justify-content-around">
            <div class="col-6 big-card mx-4 d-flex flex-column align-items-center">
                <a class="tvhome-a d-flex flex-column align-items-center" href="<?= URL ?>category.php?category=TV/Home&sub_category=HomePod mini#display">
                    <p class="homepod-p text-center">HomePod mini</p>
            ...
            <div class="col-6 big-card mx-4 d-flex flex-column align-items-center">
                <a class="tvhome-a d-flex flex-column align-items-center" href="<?= URL ?>category.php?category=TV/Home&sub_category=Apple TV 4K#display">
                    ...
                    <p class="text-center">Starting at 169 €</p>
